...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-1.89-kirby-problem-1.89-942ab0a2-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-1.89"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-1.89-kirby-problem-1.89-942ab0a2-v1",
      "problem_contract_sha256": "255269c82955bd2c6ad5839af83b77ea4d9a5d2fecf0027e4dfc634aa8758d8d",
      "problem_id": "problem:um-kp-1.89-kirby-problem-1.89-942ab0a2",
      "route_id": "route:um-kp-1.89-kirby-problem-1.89-942ab0a2-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-1.89-kirby-problem-1.89-942ab0a2-source-fidelity-01",
      "graph_id": "graph:um-kp-1.89-kirby-problem-1.89-942ab0a2-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-1.89-kirby-problem-1.89-942ab0a2-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-1.89-kirby-problem-1.89-942ab0a2-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "(a) Fix a long link L. What is the homotopy type of the embedding space of links isotopic to L? (b) Fix a link L in a 3-manifold M. What is the homotopy type of the embed- ding space of links in M isotopic to L? (c) Given a link $L$ obtained by infecting a link $L_{1}$ by another link $L_{2}$, describe the homotopy type of component of $L$ in the space of links in terms of the components of $L_{1}$ and $L_{2}$."
          },
          "statement_sha256": "e506e684d4bf9afba95b1e55e62d6fe7f476425f4c656ffd5a0a6662460aa8fd"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-1.89-kirby-problem-1.89-942ab0a2-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-1.89-kirby-problem-1.89-942ab0a2-root",
      "route_id": "route:um-kp-1.89-kirby-problem-1.89-942ab0a2-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-1.89-6af836069672",
        "url": "https://www.unsolvedmath.com/problems/KP-1.89"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
